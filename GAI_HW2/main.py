...
def parse_args(input_args=None):
    parser = argparse.ArgumentParser(description='Main script for GAI HW2 , paper introduction generate from abstract')
    # Required File Paths
    ...
    parser.add_argument("--gradient_update_period",
            type=int,
            default=1000,
            help=(
                "the period of storage gradient update, default is 1000."
            )
    )
    # training options
    ...
    parser.add_argument("--report_to", type=str, default="tensorboard",
        help= "The integration to report the results and logs to. Supported platforms are tensorboard(default). Use all to report to all integrations."
    )
