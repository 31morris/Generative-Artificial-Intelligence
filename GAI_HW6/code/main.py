...
def parse_args(input_args=None):
    parser = argparse.ArgumentParser(description="Main script for training DiT.")
    parser.add_argument(
        "--deepspeed",
        type=str,
        default=None,
    ...
    parser.add_argument("--img_path", type=str, default=None, help='Path to the images')
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Whether or not to use exponential moving averages (EMA) to update the model parameters. This can help"
            " stabilize the training and improve the model's generalization performance. See"
            " https://www.tensorflow.org/tutorials/generative/style_transfer#using_exponential_moving_averages_for_stabilization"
